...
(function (Elements) {
    ...
    Elements.ADD_BLOCK_ELEM_VIEW = '#addBlockView';
    Elements.GOOGLE_MAPS_LOCATION = '#googleMapsLocation';
    Elements.GOOGLE_MAPS_SCENE_LOCATION = '#googleMapsSceneLocation';
    ...
    Elements.LOCATION_SIMULATION_MODE = "#locationlSimulationMode";
    ...
    Elements.TOTAL_MAP_LOCATIONS = '#totalMapLocations';
    Elements.ADD_RESOURCE_TO_COLLECTION = '#addResourceToCollection';
    Elements.OPEN_GOOGLE_MAPS = '#openGoogleMaps';
    Elements.REMOVE_RESOURCE_FOR_COLLECTION = '#removeResourceForCollection';
    Elements.REMOVE_RESOURCE_FOR_LOCATION = '#removeResourceForLocation';
    ...
    Elements.BLOCK_COMMON_SETTINGS_GOOGLE_CALENDAR = '#blockCommonSettingsGoogleCalendar';
    Elements.BLOCK_COMMON_SETTINGS_TWITTERV3 = '#blockCommonSettingsTwitterV3';
    Elements.BLOCK_COMMON_SETTINGS_INSTAGRAM = '#BlockInstagram';
    Elements.BLOCK_COMMON_SETTINGS_MEDIA_FEED = '#BlockInstagramMedia';
    Elements.BLOCK_COMMON_SETTINGS_DIGG = '#blockCommonSettingsDigg';
    ...
    Elements.BLOCK_PROPERTIES_TABBER = '#blockPropertiesTabber';
    ...
    Elements.BLOCK_JSON_COMMON_PROPERTIES = '#blockJsonCommonProperties';
    Elements.BLOCK_JSON_ITEM_COMMON_PROPERTIES = '#blockJsonItemCommonProperties';
    ...
    Elements.BOOTBOX_CREATE_DESIGN = '#booxboxCreateDesign';
    Elements.BOOTBOX_PRE_MADE_SCENES = '#booxboxPreMadeScenes';
    Elements.BOOTBOX_START_BLANK = '#booxboxStartBlank';
    Elements.BOOTBOX_FROM_TEMPLATE = '#booxboxFromTemplate';
    Elements.BOOTBOX_JSON_WEATHER_DESC = '#booxboxJsonWeatherDesc';
    Elements.BOOTBOX_JSON_SHEETS_DESC = '#booxboxJsonSheetsDesc';
    Elements.BOOTBOX_JSON_CALENDAR_DESC = '#booxboxJsonCalendarDesc';
    Elements.BOOTBOX_JSON_TWITTER_DESC = '#booxboxJsonTwitterDesc';
    Elements.BOOTBOX_JSON_INSTAGRAM_DESC = '#booxboxJsonInstagramDesc';
    Elements.BOOTBOX_JSON_DIGG_DESC = '#booxboxJsonDiggDesc';
    ...
    Elements.CHANNEL_LIST_ELEM_VIEW = '#channelListView';
    ...
    Elements.CLASS_ACCESS_TOKEN = '.accessToken';
    Elements.CLASS_GEN_TOKEN = '.genToken';
    Elements.CLASS_START_UPGRADE = '.startUpgrade';
    Elements.CLASS_SHOW_UPGRADE_MODAL = '.showUpgradeModal';
    Elements.CLASS_ADD_RESOURCE_LOCATION = '.addResourceToLocation';
    ...
    Elements.CLASS_LOCATION_SIMULATION_MODE = ".locationlSimulationMode";
    Elements.CLASS_LOCATION_SIMULATION_PROPS = '.locationSimulationProps';
    ...
    Elements.CLASS_LIVE_RENAME = '.liveRename';
    ...
    Elements.JSON_ITEM_DUAL_NUMERIC2 = '#jsonItemDualNumeric2';
    Elements.JSON_ITEM_DUAL_NUMERIC_SETTINGS = '#jsonItemDualNumericSettings';
    Elements.JSON_ITEM_FIELD_CONTAINER = '#jsonItemFieldContainer';
    Elements.JSON_ITEM_TEXT_FIELDS = '#jsonItemTextFields';
    Elements.JSON_ITEM_TEXT_FIELDS_CONTAINER = '#jsonItemTextFieldsContainer';
    ...
    Elements.JSON_PLAY_VIDEO_COMPLETION = '#jsonPlayVideoCompletion';
    Elements.JSON_RANDOM_PLAYBACK = '#jsonRandomPlayback';
    Elements.JSON_ITEM_MAINTAIN_ASPECT_RATIO = '#jsonItemMaintainAspectRatio';
    Elements.JSON_SLIDESHOW = '#jsonSlideshow';
    Elements.JSON_EVENTS_TABLE = '#jsonEventsTable';
    Elements.JSON_PATHS_CONTAINER = '#jsonPathsContainer';
    ...
    Elements.MSG_LIVEINPUT_NOT_BLANK = '#liveInputMsgNotBlank';
    Elements.MSG_LIVEINPUT_SECONDS = '#liveInputMsgSeconds';
    Elements.MSG_LIVEINPUT_NO_IP = '#liveInputMsgNotIp';
    Elements.MSG_LIVEINPUT_NOT_PORT = '#liveInputMsgNotPort';
    ...
    Elements.MSG_BOOTBOX_TOKEN_TOO_SHORT = '#bootBoxTokenTooShort';
    Elements.MSG_BOOTBOX_POPUP_BLOCKED = '#bootBoxPopupBlocked';
    ...
    Elements.LOCATION_SELECTED = '#locationSelected';
    Elements.LOCATION_TABLE = '#locationTable';
    Elements.LOCATION_CONTROLS = '#locationControls';
    ...
    Elements.STATION_SERVER_MODE = '#stationServerMode';
    Elements.STATION_STOP_COMMAND = '#stationStopCommand';
    Elements.STATION_TOTAL_MEMORY = '#stationTotalMemory';
    Elements.STATION_SERVER_PROPS = '#stationServerProps';
    Elements.STATION_SERVER_IP = '#stationServerIp';
    Elements.STATION_SERVER_PORT = '#stationServerPort';
    Elements.STATION_WATCHDOG = '#stationWatchdog';
    Elements.STATIONS_PANEL = '#stationsPanel';
    Elements.STORYLINE_ELEM = '#storyLine';
    ...
    Elements.TWITTER_FILTER_SCREEN_NAME = '#twitterFilterScreenName';
    ...
    Elements.UPGRADE_MODAL = '#upgradeModal';
    Elements.UPG_CV = '#upgCV';
    Elements.UPG_YEAR = '#upgYear';
    Elements.UPG_MONTH = '#upgMonth';
    Elements.UPG_CREDIT = '#upgCredit';
    Elements.UPG_PASS2 = '#upgPass2';
    Elements.UPG_PASS = '#upgPass';
    Elements.UPG_USERNAME = '#upgUserName';
    ...
    Elements.LOCATION_RESOURCE_NAME = '#locationResourceName';
    Elements.LOCATION_RESOURCE_LAT = '#locationResourceLat';
    Elements.LOCATION_RESOURCE_LNG = '#locationResourceLng';
    Elements.LOCATION_RESOURCE_DURATION = '#locationResourceDuration';
    Elements.LOCATION_RADIUS_WRAP_SLIDER = '#locationRadiusWrapSlider';
    Elements.LOCATION_RADIUS_LABEL = '#locationRadiusLabel';
    Elements.LOCATION_PRIORITY_METER = '#locationPriorityMeter';
    Elements.WEATHER_UNIT = '#weatherUnit';
    Elements.WEATHER_STYLE = '#weatherStyle';
    Elements.WEATHER_ADDRESS = '#weatherAddress';
    Elements.GOOGLE_SHEET = '#googleSheet';
    Elements.GOOGLE_SHEET_REFRESH = '#googleSheetRefresh';
    Elements.GOOGLE_SHEET_TOKEN = '#googleSheetToken';
    Elements.GOOGLE_CALENDAR = '#googleCalendar';
    Elements.GOOGLE_CALENDAR_TOKEN = '#googleCalendarToken';
    Elements.GOOGLE_CALENDAR_REFRESH = '#googleCalendarRefresh';
    Elements.GOOGLE_CALENDAR_MODE = '#googleCalendarMode';
    Elements.CALENDAR_OFFSET_MODE = '#calendarOffset';
    Elements.CALENDAR_FIXED_MODE = '#calendarFixedMode';
    Elements.DAYS_BEFORE_TODAY_INPUT = '#daysBeforeTodayInput';
    Elements.DAYS_AFTER_TODAY_INPUT = '#daysAfterTodayInput';
    Elements.GOOGLE_CALENDAR_START = '#googleCalendarStart';
    Elements.GOOGLE_CALENDAR_END = '#googleCalendarEnd';
