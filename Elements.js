...
Elements.APP_TUTORIAL = '#appTutorial';
...
Elements.KIOSK_KEVENTS_CONTAINER = '#kioskEventsContainer';
...
Elements.TUTORIAL_CAMPAIGN_LIST1 = '#tutorialCampaignList1';
Elements.TUTORIAL_CAMPAIGN_LIST3 = '#tutorialCampaignList3';
Elements.TUTORIAL_SCENE_LIST1 = '#tutorialSceneList1';
Elements.TUTORIAL_SCENE_LIST2 = '#tutorialSceneList2';
Elements.TUTORIAL_SCENE_LIST3 = '#tutorialSceneList3';
Elements.TUTORIAL_RESOUCRES1 = '#tutorialResources1';
Elements.TUTORIAL_RESOUCRES2 = '#tutorialResources2';
Elements.TUTORIAL_RESOUCRES3 = '#tutorialResources3';
Elements.TUTORIAL_ADD_SCREEN_LAYOUT = '#tutorialAddScreenLayout';
Elements.TUTORIAL_INSTALL = '#tutorialInstall';
Elements.TUTORIAL_HELP = '#tutorialHelp';
Elements.TUTORIAL_STATIONS = '#tutorialStations';
Elements.TUTORIAL_EDIT_SCREEN_LAYOUT = '#tutorialEditScreenLayout';
Elements.TUTORIAL_ADD_BLOCK = '#tutorialAddBlock';
Elements.TUTORIAL_DEFAULT = '#tutorialDefault';
Elements.TUTORIAL_SCENE = '#tutorialScene';
Elements.TUTORIAL_TIMELINE1 = '#tutorialTimeline1';
Elements.TUTORIAL_TIMELINE2 = '#tutorialTimeline2';
Elements.TUTORIAL_TIMELINE3 = '#tutorialTimeline3';
Elements.TUTORIAL_STORYBOARD1 = '#tutorialStoryboard1';
Elements.TUTORIAL_STORYBOARD2 = '#tutorialStoryboard2';
Elements.TUTORIAL_EDIT_CAMPAIGN_SETT = '#tutorialEditCampaignSett';
Elements.TUTORIAL_EDIT_SCENE_SETT = '#tutorialEditSceneSett';
Elements.TUTORIAL_NEW_CAMPAIGN = '#tutorialNewCampaign';
Elements.TUTORIAL_NEW_SCENE = '#tutorialNewScene';
Elements.TUTORIAL_CONTENT = '#tutorialContent';
Elements.TUTORIAL_NEXT_CHANNEL = '#tutorialNextChannel';
Elements.TUTORIAL_RESOURCE_UPLOAD = '#tutorialResourceUpload';
