...
define(['jquery', 'BlockJsonBase', 'validator'], function ($, BlockJsonBase, validator) {
    ...
    var BlockDigg = (function (_super) {
        ...
        /**
         ...
         @return {string} token
         **/
        BlockDigg.prototype._getToken = function () {
            var self = this;
        ...
        /**
         ...
         @return {string} id
         **/
        BlockDigg.prototype._getFileId = function () {
            var self = this;
            var domPlayerData = self._getBlockPlayerData();
            var item = $(domPlayerData).find('Json').find('Data');
            return $(item).attr('id');
         ...
         **/
        BlockDigg.prototype._listenRefreshSheetList = function () {
            var self = this;
         ...
         **/
        BlockDigg.prototype._listenSheetChanged = function () {
            var self = this;
         ...
         **/
        BlockDigg.prototype._listenTokenChanged = function () {
            var self = this;
         ...
         **/
        BlockDigg.prototype._clearSheetList = function () {
            var self = this;
         ...
         **/
        BlockDigg.prototype._loadSheetList = function () {
            var self = this;
        ...
        /**
         ...
         @method _populate
         **/
        BlockDigg.prototype._populate = function () {
            var self = this;
