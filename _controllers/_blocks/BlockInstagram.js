...
define(['jquery', 'BlockJsonBase', 'validator'], function ($, BlockJsonBase, validator) {
    ...
    /**
     BlockInstagram is based on JSON base class component
     @class BlockInstagram
     @constructor
     @return {Object} instantiated BlockInstagram
     6e2919a1-47f0-4a4f-bd94-de7ecfbe604d
     **/
    var BlockInstagram = (function (_super) {
        __extends(BlockInstagram, _super);
        function BlockInstagram(options) {
            this.m_options = options;
            this.m_blockType = 6050;
        ...
        /**
         ...
         @method initialize
         **/
        BlockInstagram.prototype.initialize = function () {
            var self = this;
            _super.prototype.initialize.call(this, this.m_options);
            self.m_mimeType = 'Json.instagram.feed';
         ...
         **/
        BlockInstagram.prototype._listenGetNewToken = function () {
            var self = this;
         ...
         **/
        BlockInstagram.prototype._listenTokenChanged = function () {
            var self = this;
        ...
        /**
         ...
         @method _listenFilterScreenNameChange
         **/
        BlockInstagram.prototype._listenFilterScreenNameChange = function () {
            var self = this;
         ...
         **/
        BlockInstagram.prototype._initSettingsPanel = function () {
            var self = this;
            self.m_blockProperty.initSettingsPanel(Elements.BLOCK_COMMON_SETTINGS_INSTAGRAM);
        };
        /**
         ...
         **/
        BlockInstagram.prototype._loadBlockSpecificProps = function () {
            var self = this;
            self.m_blockProperty.viewSettingsPanel(Elements.BLOCK_COMMON_SETTINGS_INSTAGRAM);
        ...
        /**
         ...
         @method _populate
         **/
        BlockInstagram.prototype._populate = function () {
            var self = this;
         ...
         **/
        BlockInstagram.prototype.deleteBlock = function (i_memoryOnly) {
            var self = this;
        ...
        return BlockInstagram;
    })(TSLiteModules.BlockJsonBase);
    return BlockInstagram;
});
//# sourceMappingURL=BlockInstagram.js.map