...
declare module TSLiteModules {
    export class BlockInstagram extends TSLiteModules.BlockJsonBase implements IBlocks.IBlock {
...
define(['jquery', 'BlockJsonBase', 'validator'], function ($, BlockJsonBase, validator) {
     ...
     **/
    class BlockInstagram extends TSLiteModules.BlockJsonBase implements IBlocks.IBlock {
