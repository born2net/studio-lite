...
define(['jquery', 'Block'], function ($, Block) {
    ...
    class BlockJson extends TSLiteModules.Block {
        ...
        private m_randomPlayback:Function;
        private m_slideShow:Function;
        private m_urlChange:Function;
        private m_bindScene:Function;
         ...
         **/
        _setJsonBlockGlobalValidationOwner(i_this) {
            // add draggable icons
         ...
         **/
        _populateSceneLabel(i_sceneName?:any) {
            var self = this;
         ...
         **/
        _populateEventVisibility(i_slideShow) {
            if (i_slideShow == "1") {
         ...
         **/
        _populateObjectPath(i_objectPath) {
            var self = this;
         ...
         **/
        _populateObjectPlayToCompletion(i_playToCompletion) {
            var self = this;
         ...
         **/
        _populateSlideShow(i_slideshow) {
            var self = this;
            if (i_slideshow == '1') {
         ...
         **/
        _populateRandomPlayback(i_randomPlayback) {
            var self = this;
