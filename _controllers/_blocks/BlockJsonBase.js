...
define(['jquery', 'Block'], function ($, Block) {
    ...
    var BlockJsonBase = (function (_super) {
         ...
         **/
        BlockJsonBase.prototype._listenJsonRowEventChanged = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenAddEvent = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenRemoveEvent = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._populateTableEvents = function () {
            var self = this;
            var data = [], rowIndex = 0;
            var domPlayerData = self._getBlockPlayerData();
         ...
         **/
        BlockJsonBase.prototype._setJsonBlockGlobalValidationOwner = function (i_this) {
            // add draggable icons
         ...
         **/
        BlockJsonBase.prototype._listenActionURLChange = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenDropdownEvenActionSelection = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._populateInterval = function (i_interval) {
            var self = this;
        ...
        /**
         ...
         @param {String} i_url
         **/
        BlockJsonBase.prototype._populateUrlInput = function (i_url) {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._populate = function () {
            var self = this;
            var domPlayerData = self._getBlockPlayerData();
         ...
         **/
        BlockJsonBase.prototype._populateEventVisibility = function (i_slideShow) {
            if (i_slideShow == "1") {
         ...
         **/
        BlockJsonBase.prototype._populateObjectPath = function (i_objectPath) {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._populateObjectPlayToCompletion = function (i_playToCompletion) {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._populateSlideShow = function (i_slideshow) {
            var self = this;
            if (i_slideshow == '1') {
         ...
         **/
        BlockJsonBase.prototype._populateRandomPlayback = function (i_randomPlayback) {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenIntervalChange = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._listenObjectPathChange = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._listenVideoPlayToCompletion = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._listenRandomPlayback = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._listenSlideShowMode = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._listenUrlChange = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenSceneListChange = function () {
            var self = this;
         ...
         **/
        BlockJsonBase.prototype._listenSceneDropdownChange = function () {
            var self = this;
        ...
        /**
         ...
         @return none
         **/
        BlockJsonBase.prototype._loadBlockSpecificProps = function () {
            var self = this;
            self._populate();
         ...
         **/
        BlockJsonBase.prototype.deleteBlock = function (i_memoryOnly) {
            var self = this;
