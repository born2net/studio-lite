/**
 Application scenes template list
...
define(['jquery', 'backbone'], function ($, Backbone) {
    ...
    Backbone.SERVICES.SCENE_TEMPLATES = 'ScenesTemplates';

    var SceneTemplaes = Backbone.Model.extend({
         ...
         **/
        initialize: function () {
            BB.comBroker.setService(Backbone.SERVICES.SCENE_TEMPLATES, this);
